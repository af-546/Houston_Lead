...
const iconMap = {
  ...
  meetup: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden>
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm.045 17.34c-2.966 0-5.373-2.407-5.373-5.373S9.079 6.594 12.045 6.594s5.373 2.407 5.373 5.373-2.407 5.373-5.373 5.373z" />
    </svg>
  ),
  eventbrite: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden>
      <path d="M18.5 3.5H5.5A2.5 2.5 0 003 6v12a2.5 2.5 0 002.5 2.5h13A2.5 2.5 0 0021 18V6a2.5 2.5 0 00-2.5-2.5zM7 8h10v2H7V8zm0 4h10v2H7v-2z" />
    </svg>
  ),
};

  ...
  return (
    <section className="section-padding section-spacing section-band">
      <Reveal className="section-container mb-12">
        <p className="eyebrow mb-4">Member stories</p>
        <h2 className="heading-lg">What members say</h2>
        <p className="text-ink-soft mt-3 max-w-xl">Real connections, real business growth.</p>
      </Reveal>
